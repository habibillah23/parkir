...
<head>
    ...
    <title>Daftar Akun - Sistem Parkir</title>
    <script src="https://cdn.tailwindcss.com"></script>
</head>
<body class="bg-slate-950 min-h-screen flex items-center justify-center relative overflow-hidden">

    <!-- Ambient glow blobs -->
    <div class="absolute -top-24 -left-24 h-72 w-72 rounded-full bg-emerald-600/15 blur-3xl"></div>
    <div class="absolute -bottom-24 -right-24 h-72 w-72 rounded-full bg-blue-600/15 blur-3xl"></div>
    ...
    <div class="relative overflow-hidden rounded-2xl bg-gradient-to-br from-slate-900 to-slate-950 shadow-[0_0_40px_-8px_rgba(59,130,246,0.35)] ring-1 ring-slate-700/50 w-full max-w-sm p-8">
        ...
        <div class="relative text-center mb-8">
            ...
            <p class="text-sm text-gray-400 mt-1">Buat akun baru untuk melanjutkan</p>
        </div>
        ...
        <form action="{{ route('register') }}" method="POST" class="relative space-y-4">
            @csrf
            <div>
        ...
        <p class="relative text-center text-sm text-gray-400 mt-6">
            Sudah punya akun?
            <a href="{{ route('login') }}" class="text-blue-400 hover:text-blue-300 hover:underline font-medium">Login</a>
        </p>
    </div>
</body>
</html>